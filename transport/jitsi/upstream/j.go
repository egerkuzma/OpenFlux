...
import (
	...
	"openflux/transport/jitsi/upstream/internal/colibri"
	"openflux/transport/jitsi/upstream/internal/jingle"
	"openflux/transport/jitsi/upstream/internal/peer"
	"openflux/transport/jitsi/upstream/internal/xmpp"
)

type Config struct {
	Host     string // e.g. "meet.example.org"
